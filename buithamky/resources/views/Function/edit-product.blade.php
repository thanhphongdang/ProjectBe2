                                    ...
                                    <div class="row ec-vendor-uploads">
                                        <div class="col-lg-8">
                                            <div class="ec-vendor-upload-detail">
                                                <form class="row g-3" action="{{route('post.update', ['id'=> $product->id])}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="Name_Car" class="form-control slug-title"
                                                            placeholder="Casual men shirt" id="Name_Car" value="{{$product->Name_Car}}">
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea class="form-control" name="information" rows="4" >{{$product->information}}</textarea>
                                                    </div>
                                                    <div class="col-md-12">
