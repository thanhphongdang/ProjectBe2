...
<body>
            ...
            @foreach ($products as $product)
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
                    <div class="product-card">
                        <td><img src="{{ asset('assets/img/' . $product->Image) }}" alt="avatar" width="130px"
                                height="150px"></td>
                        ...
                        <div>
                            <button><a href="{{ Route('user.detail', ['id' => $product->id]) }}">View</a></button>
    ...
    <footer class="footer text-white"
        style="background: linear-gradient(to right, #131313, #131313); padding: 40px 20px;">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <p><strong>Trụ sở: </strong> Số 2287 Đường Hùng Vương, Phường Nông Trang, Thành phố Việt Trì, Tỉnh
                        Phú Thọ</p>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <p><strong>Trụ sở: </strong> Lô 8A, Đường Đồng Khởi, Phường Tân Hiệp, Thành phố Biên Hòa, Tỉnh Đồng
                        Nai</p>
            ...
            <div class="d-flex align-items-center justify-content-center">
                <div>
                    <h3 class="text-center">Cảm ơn quý khách hàng đã tin tưởng, ủng hộ, tin cậy và sử dụng dịch vụ của
                        cửa hàng chúng tôi!</h3>
                </div>
            </div>
        </div>
    </footer>
