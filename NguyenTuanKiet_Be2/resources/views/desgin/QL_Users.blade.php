  ...
  <div class="container">
    ...
    <aside class="sidebar">
      ...
      <ul>
        ...
        <li><a href="{{route('Statistics')}}">Statistical</a></li>
        <li>Product Management</li>
         <li><a href="{{ route('list.comment') }}"> Comment Management </a></li>
        ...
        <tbody id="user-table-body">
          ...
          <tr>
            ...
            <td>
              ...
              <button class="" onclick="deleteUser(this)"><a href="{{route('user.delete', ['id' => $user->id])}}">Delete</a> </button>
            </td>
          </tr>
          @endforeach
        </tbody>
