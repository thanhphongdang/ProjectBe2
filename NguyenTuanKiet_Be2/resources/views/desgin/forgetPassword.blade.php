...
<body>
    ...
    <form action="{{ route('user.postUpdatePassword') }}" class="form" method="POST">
        ...
        <div class="mt-3">
            <label for="" class="py-3" style="color: black;">OTP</label>
            <input type="text" class="form-control " name="reset_code" id="password" required>
        </div>
        <div class="mt-3">
        ...
        <div class="mt-3">
            <label for="" class="py-3" style="color: black;">Re-enter password:</label>
