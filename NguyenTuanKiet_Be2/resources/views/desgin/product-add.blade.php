											...
											<div class="ec-vendor-upload-detail">
												<form class="row g-3">
													<div class="col-md-6">
														...
														<input type="text" class="form-control slug-title" placeholder="Name Car" id="inputEmail4">
													</div>
													<div class="col-md-6">
														<label class="form-label">Product type</label>
														<select name="categories" id="Categories" class="form-select">
																<option value="t-shirt">Sport</option>
																<option value="dress">Family</option>
														</select>
													</div>
													<div class="col-md-6">
														<label for="inputEmail5" class="form-label">Price</label>
														<input type="text" class="form-control slug-title" placeholder="Price" id="inputEmail5">
													</div>
													<div class="col-md-6">
														<label class="form-label">Company Car</label>
														<select name="categories" id="Categories" class="form-select">
																<option value="t-shirt">Toyota</option>
																<option value="dress">Audi</option>
																<option value="table">Mec</option>
																<option value="sofa">Porsche</option>
														</select>
													</div>
													<!-- <div class="col-md-6">
														<label for="inputEmail7" class="form-label">Unit</label>
														<input type="text" class="form-control " placeholder="kg/meter/lb/ml" id="inputEmail7">
													</div> -->
													<div class="col-md-6">
														<label for="inputEmail8" class="form-label">Product quantity</label>
														<input type="text" class="form-control" placeholder="Product quantity" id="inputEmail8">
													</div>
													<div class="col-md-6">
														<label for="inputEmail9" class="form-label">Product price</label>
														<input type="text" class="form-control " placeholder="Product price" id="inputEmail9">
													</div>
													<div class="col-md-6">
