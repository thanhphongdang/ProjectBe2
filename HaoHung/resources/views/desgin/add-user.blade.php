									...
									<div class="row ec-vendor-uploads">
										<div class="col-lg-8">
											<div class="ec-vendor-upload-detail">
												<form class="row g-3" action="{{ route('post.add') }}" method="post" enctype="multipart/form-data">
													@csrf
												   <div class="col-md-6">
													...
													<div class="col-md-6">
														...
														<input type="text" name="email" class="form-control slug-title"
															placeholder="Email" id="inputEmail5">
													</div>
													<div class="col-md-6">
													...
													<div class="col-md-6">
														...
														<input type="phone" name="phone" class="form-control slug-title"
															placeholder="Phone" id="phone">
													</div>
													<div class="col-md-6">
														<label for="inputEmail5" class="form-label">Image</label>
														<input type="file" name="image" class="form-control slug-title"
